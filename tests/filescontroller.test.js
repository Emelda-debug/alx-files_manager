...
describe('+ FilesController', () => {
  ...
  describe('+ POST: /files', () => {
    ...
    it('+ Fails if type is missing', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.post('/files')
          .set('X-Token', token)
    ...
    it('+ Fails if type is available but unrecognized', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.post('/files')
          .set('X-Token', token)
    ...
    it('+ Fails if data is missing and type is not a folder', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.post('/files')
          .set('X-Token', token)
    ...
    it('+ Fails if unknown parentId is set', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.post('/files')
          .set('X-Token', token)
    ...
    it('+ Succeeds for valid values of a file', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.post('/files')
          .set('X-Token', token)
    ...
    it('+ Succeeds for valid values of a folder', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.post('/files')
          .set('X-Token', token)
    ...
    it('+ Fails if parentId is set and is not of a folder or 0', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.post('/files')
          .set('X-Token', token)
    ...
    it('+ Succeeds if parentId is set and is of a folder', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.post('/files')
          .set('X-Token', token)
  ...
  describe('+ GET: /files/:id', () => {
    ...
    it('+ Fails if file is not linked to user', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.get('/files/444555666')
          .set('X-Token', token)
    ...
    it('+ Succeeds if file is linked to user', function () {
      return new Promise((done) => {
        this.timeout(5000);
  ...
  describe('+ GET: /files', () => {
    ...
    it('+ Fetches first page with no page query', function () {
      return new Promise((done) => {
        this.timeout(5000);
        request.get('/files')
          .set('X-Token', token)
    ...
    it('+ Fetches first page with no page query and parentId', function () {
      return new Promise((done) => {
        this.timeout(5000);
    ...
    it('+ Returns empty list for a page that is out of bounds', function () {
      return new Promise((done) => {
        this.timeout(5000);
    ...
    it('+ Returns empty list for a parentId of a file', function () {
      return new Promise((done) => {
        this.timeout(5000);
    ...
    it('+ Returns empty list for unknown parentId', function () {
      return new Promise((done) => {
        this.timeout(5000);
  ...
  describe('+ GET: /files/:id/data', () => {
    it('+ Fails if the file does not exist', () => new Promise((done) => {
    ...
    it('+ Fails if the file is not public and not requested by the owner', () => new Promise((done) => {
    ...
    it('+ Succeeds if the file is not public but requested by the owner', () => new Promise((done) => {
      request.get(`/files/${mockFiles[0].id}/data`)
        .set('X-Token', token)
        .expect(200)
        .end((err, res) => {
    ...
    it('+ Fails if the file is a folder', function () {
      return new Promise((done) => {
        this.timeout(5000);
    ...
    it('+ Succeeds if the file is not public but requested by the owner [alt]', () => new Promise((done) => {
    ...
    it('+ Fails if the file is not locally present', function () {
      return new Promise((done) => {
        this.timeout(5000);
        emptyFolder(baseDir);
        request.get(`/files/${mockFiles[2].id}/data`)
